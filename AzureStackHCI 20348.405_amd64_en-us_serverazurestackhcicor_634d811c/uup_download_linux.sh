#!/bin/bash
#Generated on 2021-12-19 01:22:48 GMT
...
aria2c --no-conf --log-level=info --log="aria2_download.log" -o"$tempScript" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=634d811c-58a2-4f1d-819b-8833ddbe6feb&pack=en-us&edition=serverazurestackhcicor&aria2=2"
if [ $? != 0 ]; then
