#!/bin/bash
#Generated on 2021-12-19 04:08:24 GMT
...
aria2c --no-conf --log-level=info --log="aria2_download.log" -o"$tempScript" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=dd4dd51c-400b-4780-96a2-6514a2ecf9f3&pack=en-us&edition=core;coren;professional;professionaln&aria2=2"
if [ $? != 0 ]; then
