#!/bin/bash
#Generated on 2021-12-19 00:54:40 GMT
...
aria2c --no-conf --log-level=info --log="aria2_download.log" -o"$tempScript" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=6cc7ea68-b7fb-4de1-bf9b-1f43c6218f6f&pack=en-us&edition=ppipro&aria2=2"
if [ $? != 0 ]; then
