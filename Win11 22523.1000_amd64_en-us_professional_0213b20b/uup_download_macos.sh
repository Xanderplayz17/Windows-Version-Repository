#!/bin/bash
#Generated on 2021-12-19 00:45:59 GMT
...
aria2c --no-conf --log-level=info --log="aria2_download.log" -o"$tempScript" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=0213b20b-1b85-42a4-b656-1a1c936e6d17&pack=en-us&edition=professional&aria2=2"
if [ $? != 0 ]; then
