#!/bin/bash
#Generated on 2021-12-23 20:32:22 GMT
...
aria2c --no-conf --log-level=info --log="aria2_download.log" -o"$tempScript" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=94edf52f-3451-474f-9097-3d3aad3e54d8&pack=en-us&edition=ppipro&aria2=2"
if [ $? != 0 ]; then
