#!/bin/bash
#Generated on 2021-12-19 03:56:17 GMT
...
aria2c --no-conf --log-level=info --log="aria2_download.log" -o"$tempScript" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=f177d0f0-e44e-49aa-a5e9-ee258d05f245&pack=en-us&edition=core;coren;professional;professionaln&aria2=2"
if [ $? != 0 ]; then
