#!/bin/bash
#Generated on 2021-12-19 04:15:00 GMT
...
aria2c --no-conf --log-level=info --log="aria2_download.log" -o"$tempScript" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=8457f286-999e-455e-a887-723e5fb24a7e&pack=en-us&edition=core;coren;professional;professionaln&aria2=2"
if [ $? != 0 ]; then
