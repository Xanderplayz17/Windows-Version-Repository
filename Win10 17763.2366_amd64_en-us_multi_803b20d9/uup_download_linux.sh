#!/bin/bash
#Generated on 2021-12-19 01:27:09 GMT
...
aria2c --no-conf --log-level=info --log="aria2_download.log" -o"$tempScript" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=803b20d9-4675-4941-84c2-f4c97282402e&pack=en-us&edition=core;coren;professional;professionaln&aria2=2"
if [ $? != 0 ]; then
